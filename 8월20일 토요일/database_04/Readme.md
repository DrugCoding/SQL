...
```sql
sqlite> SELECT count(CustomerId) as '고객 수'
   ...> FROM customers;
고객 수
----
59
...
```sql
sqlite> SELECT country, FirstName as '성', LastName as '이름'
   ...> FROM customers
   ...> WHERE country = 'USA'
   ...> order by "이름" DESC
   ...> LIMIT 5;
...
```sql
sqlite> SELECT CustomerId, FirstName, LastName
   ...> FROM customers
...
```sql
sqlite> SELECT count(*) as '고객 수', Country
   ...> from customers
   ...> GROUP BY Country
   ...> ORDER BY "고객 수" DESC
   ...> LIMIT 5;
...
```sql 
sqlite> SELECT ArtistId, count(*) as '앨범 수'
   ...> FROM albums
   ...> GROUP BY ArtistId
   ...> HAVING "앨범 수" >= 10
   ...> ORDER BY "앨범 수" DESC;
...
sqlite> SELECT CustomerId,
   ...> CASE WHEN Fax IS NULL THEN 'X' ELSE 'O' END  as 'Fax 유/무'
   ...> FROM customers
   ...> order by CustomerId ASC
   ...> LIMIT 5;
CustomerId  Fax 유/무
